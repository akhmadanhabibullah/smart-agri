...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/location" class="mb-3" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('altitude') is-invalid @enderror" name="altitude"
                    id="altitude" required value="{{ old('altitude') }}">
                @error('altitude')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
