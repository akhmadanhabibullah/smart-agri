    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/location-2/{{ $location2->idLocation }}" class="mb-3"
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $location2->name }}" class="form-control @error('name') is-invalid @enderror"
                    name="name" id="name" required value="{{ old('name', $location2->name) }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $location2->address }}"
                    ...
                    value="{{ old('address', $location2->address) }}">
                @error('address')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
