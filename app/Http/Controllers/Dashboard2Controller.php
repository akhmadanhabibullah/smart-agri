...
class Dashboard2Controller extends Controller
{
    ...
    $ph = $moisture = $nitrogen = $phosporus = $potassium = null;
    $phIndicator = $moistureIndicator = $nitrogenIndicator = $phosporusIndicator = $potassiumIndicator = "No Data";
    ...
    if ($response->successful()) {
        ...
        // Collect the data
        $measurements2 = collect($datasmartsoil2);

        // Get the latest measurement
        $latestMeasurement = end($datasmartsoil2); // reset to get firstdata
